...
## layout.test.js — кнопка «Разложить»

Раскладка должна строить СТОЛБЦЫ: каждая ветка — своя вертикальная дорожка.
На воронке с десятью языками это разница между читаемой схемой и кашей.
Тест проверяет геометрию на настоящем алгоритме: десять веток в десять
столбцов, ветки разной длины не налезают, сошедшиеся ветки не раздваивают
узел, оторванный кусок уходит вниз, петля не вешает раскладку, высокая
карточка раздвигает ряды.
