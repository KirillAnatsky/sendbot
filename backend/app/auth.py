...
FEATURES = [
    ...
    {"key": "settings", "label": "Настройки",
     "hint": "часовой пояс проекта — по нему считаются условия «день недели», "
             "«дата» и «время срабатывания» в фильтрах"},
    {"key": "integrations", "label": "Интеграции",
     "hint": "выгрузка статистики в Google Таблицы · "
             "изменять: настраивать подключение и запускать выгрузку"},
